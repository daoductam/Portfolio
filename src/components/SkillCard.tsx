...
const SkillBadge = (skills: []) => {
  return skills.map((skill: any, index: number) => (
    <div
      key={index}
      className="flex gap-2 border border-textColor rounded-2xl items-center py-2 p-3 "
    >
      <Avatar
...
const SkillCard = (props: any) => {
  return (
    <div
      ...
      className="w-[48%] rounded-2xl shadow-[0_0_10px_0px_#64FFDA] border border-primaryColor p-5"
    >
